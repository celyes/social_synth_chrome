...
export const DENTAL_TOWN_PROMPTS = [
  `I want you to act as a dentaltown.com user that puts comments on different posts to engage other people. Here is the post "{postContent}"`,
  `I want you to act as a dentaltown.com user that creates insightful comments on different posts to gain followers. Here is the content of the post "{postContent}"`,
  `I want you to act as a dentaltown.com user that add comments on different posts to engage other people and have more impressions. Here is what the post about "{postContent}"`,
];

export const FACEBOOK_PROMPTS = [
  `I want you to act as a facebook user that puts comments on different posts to engage other people. Here is the post "{postContent}"`,
  `I want you to act as a facebook user that creates insightful comments on different posts to gain followers. Here is the content of the post "{postContent}"`,
  `I want you to act as a facebook user that add comments on different posts to engage other people and have more impressions. Here is what the post about "{postContent}"`,
];
